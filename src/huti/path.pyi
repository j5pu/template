...
from .classes import PIs
from .typings import OpenIO
from .typings import TemporaryFileType
...
class Path(pathlib.Path, pathlib.PurePosixPath, Generic[_T]):
    ...
    def __call__(self, name: AnyPath = ..., file: PIs = ..., passwd: Passwd | None = ...,
    ...
    def tempfile(cls, mode: Literal["r", "w", "a", "x", "r+", "w+", "a+", "x+", "rt", "wt", "at", "xt", "r+t",
                 ...
                 errors: str | None = ...) -> TemporaryFileType[str]: ...
